package io.magickeeper.magickeeper.api
...
object MagickeeperService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The MagicKeeper service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MagickeeperService.
  */
trait MagickeeperService extends Service {
  ...
  override final def descriptor = {
    ...
    named("magickeeper")
      ...
      .withTopics(
        topic(MagickeeperService.TOPIC_NAME, greetingsTopic)
